...
export default function H2hSync({
    products,
    filters = {},
    stats = {},
    categories = [],
    ...
    const handleResetFilter = () => {
        ...
        router.get('/admin/h2h-products', {}, { preserveState: true, preserveScroll: true, replace: true });
    };
    ...
    return (
        <AdminLayout title="Katalog Produk H2H" activeMenu="h2h">
            <Head title="Sinkronisasi Produk H2H — Maitri Admin" />
            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-16">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 relative z-10">
                        <div className="space-y-2 max-w-2xl">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-ink font-sans">
                                Katalog Raw SKU & Harga Grosir H2H
                            </h2>

                            <p className="text-xs sm:text-sm text-ink-muted leading-relaxed font-sans">
                                Mengelola seluruh master SKU game dan digital yang disinkronkan dari server provider <strong className="text-ink">Maitri Project</strong>. Data tersimpan di basis data lokal sehingga saat membuat item produk, Anda dapat memilih SKU dan harga modal akan terupdate otomatis.
                            </p>
                        </div>
                ...
                <div className="flex items-center gap-2 border-b-2 border-ink pb-2 overflow-x-auto">
                    ...
                    >
                        ...
                        <span>Katalog Master SKU H2H</span>
